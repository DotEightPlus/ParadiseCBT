...
<html lang="en">
<head>
	<title>De Guide Light | CBT</title>
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta charset="UTF-8">
    <meta name="description" content="De Guide Light | CBT">
    <meta name="keywords" content="De Guide Light | CBT">
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<span class="contact100-form-symbol">
				<img src="logo.jpeg" alt="DotEightInc - CBT Demo">
			</span>
			<form method="post" class="contact100-form validate-form flex-sb flex-w">
				<span class="contact100-form-title">
					De Guide Light School  CBT <?php echo date("Y"); ?>
				</span>
<p style="color: red">Please login to continue. Kindly contact the database administrator for login details.</p>
<br/><br/>
...
<br/>
			<p align="center">&copy; De-Guide Light School <?php echo date("Y"); ?> | Developed by: <a target="_blank" href="https://doteightplus.com"><span style="color: red;"> DotEightPlus</span> </p>
		</div>
