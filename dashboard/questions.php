                ...
                <div class="card-body">
                    <form name="uploadQuestionaire" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" id="ques"
                                placeholder="e.g What is my name?"></textarea>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                        ...
                        <button type="button" id="Questionaire"
                            class="btn float-right btn-danger btn-outline-light">Upload Question</button>
                    </form>
                </div>
                <!-- /.card-body -->
            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content bg-danger">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <p class="text-grey">Kindly confirm the question you want to delete by typing the question serial
                        number below</p>
                    ...
                    <form name="deleting">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="delsn" id="delsn" class="form-control"
                                placeholder="e.g 1, 2, 3 e.t.c">
                            <input type="text" name="val" id="val" value="<?php echo $data; ?>" class="form-control"
                                placeholder="e.g 1, 2, 3 e.t.c" hidden>
                        </div>
                    </form>
                </div>
            </div>
...
<div class="modal fade" id="modal-edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content bg-info">
            <div class="modal-header">
                <h4 class="modal-title">Edit Time Allowed & Number of Questions to be Attemptted
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
            </div>
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-outline-light" data-dismiss="modal">No! Cancel</button>
                <button type="button" id="timereseted" class="btn btn-outline-light">Yes! Continue</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
