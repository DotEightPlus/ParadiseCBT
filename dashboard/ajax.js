$(document).ready(function() 
{
	...
	(
	{
		...
		data 		:  {catclass:catclass,subject:subject,hour:hour,minutes:minutes,quess:quess,instruct:instruct},
	...
	(
	{
		type 		:  'post',
		url			:  '../functions/init.php',
		data 		:  {jssclass:jssclass,jsssubject:jsssubject,jsshour:jsshour,jssminutes:jssminutes,jssquess:jssquess,jssedit:jssedit},
		success 	:  function(data)
		{
			$(toastr.error(data)).html(data);
		}
	...
	(
	{
		type 		:  'post',
		url			:  '../functions/init.php',
		data 		:  {seniorclass:seniorclass,seniorsubject:seniorsubject,sshour:sshour,ssminutes:ssminutes,ssquess:ssquess,ssedit:ssedit},
		success 	:  function(data)
		{
			$(toastr.error(data)).html(data);
		}
	...
	(
	{
		type 		:  'post',
		url			:  '../functions/init.php',
		data 		:  {onlinesubject:onlinesubject,othour:othour,otminutes:otminutes,otquess:otquess,otedit:otedit},
		success 	:  function(data)
		{
			$(toastr.error(data)).html(data);
		}
...
//Update time and questions to be answered
	...
	(
	{
		type 		:  'post',
		url			:  '../functions/init.php',
		data 		:  {idc:idc,hourc:hourc,minutesc:minutesc,quessc:quessc,editc:editc},
		success 	:  function(data)
		{
	$(toastr.error(data)).html(data);
		}
